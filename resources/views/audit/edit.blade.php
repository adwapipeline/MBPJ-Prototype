    ...
    <div class="card-body bg-light">
      <div class="tab-content">
        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-bb654daf-be1a-40fe-b687-3e45244388c2" id="dom-bb654daf-be1a-40fe-b687-3e45244388c2">
            <form action="/audit/{{ $auditTrail->id }}" method="POST">
                @csrf
                @method('PUT')
              ...
              <input class="form-control" name="activity" type="text" placeholder="Activity" value="{{ $auditTrail->activity }}" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="date">Date</label>
                <input class="form-control" name="date" type="date" value="{{ $auditTrail->date }}" />
              </div>
            <div class="mb-3">
              <label class="form-label" for="user">User</label>
              <input class="form-control" name="user" type="user" placeholder="user" value="{{ $auditTrail->user }}"/>
            </div>
