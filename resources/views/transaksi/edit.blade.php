    ...
    <div class="card-header">
      <div class="row flex-between-end">
        <div class="col-auto flex-lg-grow-1 flex-lg-basis-0 align-self-center">
          <h5 class="mb-0" data-anchor="data-anchor">Ubah Transaksi</h5>
        </div>
      ...
      <div class="tab-content">
        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-bb654daf-be1a-40fe-b687-3e45244388c2" id="dom-bb654daf-be1a-40fe-b687-3e45244388c2">
            <form action="/transaksi/{{ $transaksi->id }}" method="POST">
              ...
              <input class="form-control" name="jumlahBayaran" type="text" placeholder="jumlahBayaran" value="{{ $transaksi->jumlahBayaran }}" />
            </div>

            <div class="mb-3">
                <label class="form-label" for="jenisLaporan">Jenis Laporan</label>
                <select class="form-select" name="jenisLaporan" value="{{ $transaksi->jenisLaporan }}">
