    ...
    <div class="card-header">
      <div class="row flex-between-end">
        <div class="col-auto flex-lg-grow-1 flex-lg-basis-0 align-self-center">
          <h5 class="mb-0" data-anchor="data-anchor">Buat Penyenlenggaraan</h5>
        </div>
    ...
    <div class="card-body bg-light">
      <div class="tab-content">
        <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-bb654daf-be1a-40fe-b687-3e45244388c2" id="dom-bb654daf-be1a-40fe-b687-3e45244388c2">
            <form action="{{ route('penyelenggaraan.store') }}" method="POST">
                @csrf
                <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="bakiBayaran" type="text" />
              </div>
